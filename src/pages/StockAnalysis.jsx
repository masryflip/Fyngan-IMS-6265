...
export default function StockAnalysis() {
  const { transactions, items, locations, formatQuantity, isLoading } = useInventory();
  ...
  }, [transactions, selectedPeriod, selectedItem, selectedLocation]);
    ...
    return (
      <div className="p-6">
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          <SafeIcon icon={FiAlertCircle} className="text-gray-400 text-4xl mb-4 mx-auto" />
          <h3 className="text-lg font-medium text-gray-900 mb-2">No Analysis Data Available</h3>
          <p className="text-gray-500">Start updating stock levels to see analysis and trends.</p>
        </div>
      </div>
    );
  }
